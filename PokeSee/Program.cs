...
static async Task<List<string>> GetTopUser()
{
    ...
    url = "https://play.pokemonshowdown.com/ladder.php?format=gen9vgc2024regg&server=showdown&output=html&prefix=";
    ...
    url = "https://play.pokemonshowdown.com/ladder.php?format=gen9vgc2024reggbo3&server=showdown&output=html&prefix=";
    ...
    url = "https://play.pokemonshowdown.com/ladder.php?format=gen9vgc2024reghbo3&server=showdown&output=html&prefix=";
    ...
    url = "https://play.pokemonshowdown.com/ladder.php?format=gen9vgc2024regh&server=showdown&output=html&prefix=";
    res = await client.GetAsync(url);
    html = await res.Content.ReadAsStringAsync();
