...
namespace PokeShitLib
{
    ...
    public class Pokemondata
    {
        ...
        public static string[] Type = { null, "火", "水", "草", "电", "一般", "格斗", "飞行", "虫", "毒", "岩石", "地面", "钢", "冰", "超能力", "恶", "幽灵", "龙", "妖精", "星晶" };
        ...
        private static string[] EngType = { null, "Fire", "Water", "Grass", "Electric", "Normal", "Fighting", "Flying", "Bug", "Poison", "Rock", "Ground", "Steel", "Ice", "Psychic", "Dark", "Ghost", "Dragon", "Fairy", "Stellar" };
...
妖精,17,EE99AC,9B6470";
        ...
        {
            if (TypeId.ContainsKey(Typename))
        ...
        public static PokemonInfo GetpPokemonUSE(string name)
        {
            ...
            {
                var like = POKEMON.FirstOrDefault(s => s.name.StartsWith(name)).name;
                if (like != null)
                {
                    PokemonInfo b = new PokemonInfo(GetPokemonBase(like));
                    b.Pokemonextend();
                    return b;
                }
            }
