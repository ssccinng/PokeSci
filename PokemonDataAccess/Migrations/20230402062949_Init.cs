        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PokeDexId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    National_Dex_Id = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Condition_UpId = table.Column<int>(type: "INTEGER", nullable: true),
                    Performance_UpId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description_Eng = table.Column<string>(type: "varchar(200)", nullable: true, comment: "英文描述"),
                    description_Jpn = table.Column<string>(type: "nvarchar(100)", nullable: true, comment: "日文描述"),
                    Pow = table.Column<int>(type: "INTEGER", nullable: true),
                    Acc = table.Column<int>(type: "INTEGER", nullable: true),
                    PP = table.Column<int>(type: "INTEGER", nullable: false),
                    MoveTypeId = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    DexId = table.Column<int>(type: "INTEGER", nullable: false, comment: "全国图鉴编号"),
                    ...
                    PokeFormId = table.Column<int>(type: "INTEGER", nullable: false, comment: "形态编号"),
                    ...
                    Stage = table.Column<int>(type: "INTEGER", nullable: false, comment: "意味無し"),
                    DMax = table.Column<bool>(type: "INTEGER", nullable: false, comment: "能否极巨化"),
                    ...
                    GenderRatio = table.Column<int>(type: "INTEGER", nullable: false, comment: "♀/(♂+♀)=(GenderRatio+1)/(255+1),254雌性,255无性别"),
                    CatchRate = table.Column<int>(type: "INTEGER", nullable: false),
                    Ability1AbilityId = table.Column<int>(type: "INTEGER", nullable: true),
                    Ability2AbilityId = table.Column<int>(type: "INTEGER", nullable: true),
                    AbilityHAbilityId = table.Column<int>(type: "INTEGER", nullable: true),
                    Type1Id = table.Column<int>(type: "INTEGER", nullable: true),
                    Type2Id = table.Column<int>(type: "INTEGER", nullable: true),
                    EXPGroup = table.Column<int>(type: "INTEGER", nullable: false, comment: "1:Erratic,2:Fast,3:Medium Fast,4:Medium Slow,5:Slow"),
                    EggGroup1EggGroupId = table.Column<int>(type: "INTEGER", nullable: true),
                    EggGroup2EggGroupId = table.Column<int>(type: "INTEGER", nullable: true),
                    HatchCycles = table.Column<int>(type: "INTEGER", nullable: false, comment: "孵化周期"),
                    Height = table.Column<decimal>(type: "decimal(5, 2)", nullable: false),
                    Weight = table.Column<decimal>(type: "decimal(4, 1)", nullable: false),
                    Color = table.Column<int>(type: "INTEGER", nullable: false, comment: "0-9:红色,蓝色,绿色,黄色,紫色,粉红色,褐色,黑色,灰色,白色"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name_Eng = table.Column<string>(type: "varchar(20)", nullable: true, comment: "英文名"),
                    Name_Jpn = table.Column<string>(type: "nvarchar(10)", nullable: true, comment: "日文名"),
                    FlavorId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name_Jpn = table.Column<string>(type: "nvarchar(10)", nullable: true, comment: "日文名"),
                    Stat_UpId = table.Column<int>(type: "INTEGER", nullable: true),
                    Stat_DownId = table.Column<int>(type: "INTEGER", nullable: true),
                    Perf_UpId = table.Column<int>(type: "INTEGER", nullable: true),
                    Perf_DownId = table.Column<int>(type: "INTEGER", nullable: true),
                    Flavor_UpId = table.Column<int>(type: "INTEGER", nullable: true),
                    Flavor_DownId = table.Column<int>(type: "INTEGER", nullable: true),
                    Performance_value = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
