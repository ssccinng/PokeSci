...
namespace PokeUI3.PokeControl
{
    public sealed partial class BSTView : UserControl
    {
        ...
        public int Atk
        {
            get { return (int)GetValue(AtkProperty); }
            set { SetValue(AtkProperty, value); }
        }
        ...
        public int Spa
        {
            get { return (int)GetValue(SpaProperty); }
            set { SetValue(SpaProperty, value); }
        }
        ...
        public int Spd
        {
            get { return (int)GetValue(SpdProperty); }
            set { SetValue(SpdProperty, value); }
        }
        ...
        public int Spe
        {
            get { return (int)GetValue(SpeProperty); }
            set { SetValue(SpeProperty, value); }
        }
